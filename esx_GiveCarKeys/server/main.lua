...
AddEventHandler('esx_givecarkeys:setVehicleOwnedPlayerId', function (playerId, vehicleProps)
	...
	function (rowsChanged)
		TriggerClientEvent('esx:showNotification', playerId, 'Artık yeni bir aracın var. Plakası: ~g~' ..vehicleProps.plate..'!', vehicleProps.plate)
	end)
end)
...
RegisterCommand('arabaver', function(source, args, user)
TriggerClientEvent('esx_givecarkeys:keys', source)
end)