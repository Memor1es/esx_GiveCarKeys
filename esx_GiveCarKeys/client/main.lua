...
function giveCarKeys()
	...
	ESX.TriggerServerCallback('esx_givecarkeys:requestPlayerCars', function(isOwnedVehicle)
		if not isOwnedVehicle then
			ESX.ShowNotification('Yakında verebileceğin bir araba yok.')
...
if closestPlayer == -1 or closestDistance > 3.0 then
  ESX.ShowNotification('Yakında bir oyuncu yok!')
else
  ESX.ShowNotification('Aracınızın anahtarlarınızı veriyorsunuz.. Araç Plaka: ~g~'..vehicleProps.plate..'!')
